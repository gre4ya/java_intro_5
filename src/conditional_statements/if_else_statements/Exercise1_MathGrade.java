...
public class Exercise1_MathGrade {
    public static void main(String[] args) {
        ...
        Write a program that asks David what his grade is.
        If David’s grade is greater than or equal to 60,
            then print message: “Awesome! You have passed the math class!”.
        If David’s grade is less than 60,
            then print message: “Sorry!  You failed!”.
         */
